package archmagus.render.layer;
...
public class LayerHeldItemSummonedWitch implements LayerRenderer<EntitySummonedWitch>
{
    private final RenderSummonedWitch witchRenderer;

    public LayerHeldItemSummonedWitch(RenderSummonedWitch witchRendererIn)
    {
        this.witchRenderer = witchRendererIn;
    }

    public void doRenderLayer(EntitySummonedWitch entitylivingbaseIn, float p_177141_2_, float p_177141_3_, float partialTicks, float p_177141_5_, float p_177141_6_, float p_177141_7_, float scale)
    {
