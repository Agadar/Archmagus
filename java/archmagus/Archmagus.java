...
import archmagus.entity.ModEntities;
import archmagus.eventhandler.ModEventHandlers;
import archmagus.gui.ModGuiHandler;
import archmagus.items.ItemAppleMana;
import archmagus.items.ItemManaCrystal;
import archmagus.items.ItemPotionBase;
import archmagus.items.ItemSpell;
import archmagus.items.ItemSpellBook;
import archmagus.items.StrictBrewingRecipe;
...
public class Archmagus
{
	...
	public static final String CLIENTSIDE = "archmagus.ClientProxy";
	public static final String SERVERSIDE = "archmagus.CommonProxy";
