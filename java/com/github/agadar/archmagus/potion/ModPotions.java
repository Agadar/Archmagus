package com.github.agadar.archmagus.potion;
...
public class ModPotions 
{
	...
	static
	{
		...
		fireShield = new PotionBase(new ResourceLocation("fireShield"), false, 14981690).setIconIndex(1, 0).setPotionName("potion.buff.fire");
		earthShield = new PotionBase(new ResourceLocation("earthShield"), false, 10044730).setIconIndex(2, 0).setPotionName("potion.buff.earth");
		waterShield = new PotionBase(new ResourceLocation("waterShield"), false, 3035801).setIconIndex(3, 0).setPotionName("potion.buff.water");
		stormShield = new PotionBase(new ResourceLocation("stormShield"), false, 8171462).setIconIndex(4, 0).setPotionName("potion.buff.storm");
		frostShield = new PotionBase(new ResourceLocation("frostShield"), false, 15463164).setIconIndex(5, 0).setPotionName("potion.buff.frost");
