...
public class EntityAIFollowOwnerHorse extends EntityAIBase
{
    private EntitySummonedHorse thePet;
    ...
    public EntityAIFollowOwnerHorse(EntitySummonedHorse p_i1625_1_, double p_i1625_2_, float p_i1625_4_, float p_i1625_5_)
    {
    ...
    {
        EntityLivingBase entitylivingbase = this.thePet.getTamedBy();
